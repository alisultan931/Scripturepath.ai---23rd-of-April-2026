              ...
              {mode !== "forgot" && (
                <>
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 rounded-lg border border-white/10 bg-white/5 py-3 px-4 text-sm text-white transition-all duration-200 hover:bg-white/10"
                  >
