...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media print {
    ...
    /* Never split a paragraph, list item, blockquote, or card mid-page */
    p, li, blockquote,
    .step, .kf-row, .panel-item, .qf-point,
    .q-group, .s10-takeaway { break-inside: avoid; }
  }
</style>
</head>
<body>
